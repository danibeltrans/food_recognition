...
def main(dir_path, model_name=None):
    ...
    valid_sources = dt.build_sources_from_metadata(metadata, dir_path, exclude_labels=exclude_labels, mode='valid')
